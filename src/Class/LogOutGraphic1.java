 ...
 * @author yunus
 */
public class LogOutGraphic1 extends JFrame {

    public LogOutGraphic1() {
        super("Entry");
    ...
    public void paint(Graphics g) {
        ...
        // draw the mouth
        g.fillOval(140, 140, 120, 60);

        // "touch up" the mouth into a smile
        g.setColor(Color.RED);
//        g.fillRect(140, 140, 120, 30);
//        g.fillOval(140, 120, 120, 40);
        ...
        g2d.drawString("SUCCESFULLY LOG OUT", 35, 300);
        g2d.drawRect(10, 240, 370, 120);
    }

    public static void main(String[] args) {
        LogOutGraphic1 panel = new LogOutGraphic1();
